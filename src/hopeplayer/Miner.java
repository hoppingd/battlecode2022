    ...
    MapLocation flee() {
        ...
        for (RobotInfo r : nearbyEnemies) {
            ...
            if (r.getType() == RobotType.ARCHON) {
                ...
                try {
                    if (comm.getTask() != 4 && mapLeadScore < Communication.HIGH_LEAD_THRESHOLD && rc.senseNearbyLocationsWithLead(RobotType.MINER.visionRadiusSquared).length > 9) { // sense should crunch
            ...
            if (comm.getTask() != 4 && r.getType() == RobotType.BUILDER || r.getType() == RobotType.LABORATORY) {
                comm.setTask(4);
            }
        }
